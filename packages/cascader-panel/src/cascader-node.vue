...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return <i class="tea-icon tea-icon-check el-icon-check el-cascader-node__prefix"></i>;
    },

    renderLoadingIcon(h) {
      return <i class="tea-icon tea-icon-loading el-icon-loading el-cascader-node__postfix"></i>;
    },

    renderExpandIcon(h) {
      return <i class="tea-icon tea-icon-arrowright el-icon-arrow-right el-cascader-node__postfix"></i>;
    },
