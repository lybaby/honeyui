...
/* harmony default export */ var tab_navvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    scrollNext: function scrollNext() {
      ...
      var containerSize = this.$refs.navScroll['offset' + tab_navvue_type_script_lang_js_firstUpperCase(this.sizeName)];
      var currentOffset = this.navOffset - 40;
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      'a',
      { 'class': ['tea-btn tea-btn--icon tea-tabs__backward', scrollable.prev ? '' : 'is-disabled'], on: {
          'click': scrollPrev
        }
      },
      [h('i', { 'class': 'tea-icon tea-icon-arrowleft' })]
    ), h(
      'a',
      { 'class': ['"tea-btn tea-btn--icon tea-tabs__forward', scrollable.next ? '' : 'is-disabled'], on: {
          'click': function click() {
            scrollNext();
          }
        }
      },
      [h('i', { 'class': 'tea-icon tea-icon-arrowright' })]
    )] : null;
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      return h(
        ...
        [h(
          'a',
          { 'class': { 'tea-tabs__tab': true, 'is-active': pane.active }
          },
          [' ', tabLabelContent]
        ), btnClose]
      );
    ...
    return h(
      'div',
      { 'class': ['tea-tabs__scroll-area', scrollable ? 'is-scrolling' : ''], ref: 'navScroll' },
      [h(
        'ul',
        {
  ...
  render: function render(h) {
    ...
    return h(
      ...
      { 'class': (_ref2 = {
        ...
        }, _ref2[tabPosition] = true, _ref2['el-tabs--border-card'] = type === 'border-card', _ref2) },
