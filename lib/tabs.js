...
/* harmony default export */ var tab_navvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      'a',
      {
        'class': ['tea-btn tea-btn--icon tea-tabs__backward', scrollable.prev ? '' : 'is-disabled'],
        on: {
          'click': scrollPrev
        }
      },
      ...
      'a',
      {
        'class': ['"tea-btn tea-btn--icon tea-tabs__forward', scrollable.next ? '' : 'is-disabled'],
        on: {
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      return h(
        ...
        [h(
          'a',
          { 'class': { 'tea-tabs__tab': true, 'is-active': pane.active, 'is-disabled': pane.disabled } },
          [' ', tabLabelContent]
        ), btnClose]
      );
    });
