...
module.exports = require("honey-ui/lib/utils/aria-utils");
...
module.exports = require("honey-ui/lib/radio");
...
// EXTERNAL MODULE: external "honey-ui/lib/radio"
var radio_ = __webpack_require__(55);
  ...
  methods: {
    handleExpand: function handleExpand() {
      ...
      if (checkStrictly && !multiple) {
        ...
        _panel.handleCheckChange(value);
      }
    ...
    renderCheckIcon: function renderCheckIcon(h) {
      return h('i', { 'class': 'tea-icon tea-icon-check el-icon-check el-cascader-node__prefix' });
    },
    renderLoadingIcon: function renderLoadingIcon(h) {
      return h('i', { 'class': 'tea-icon tea-icon-loading el-icon-loading el-cascader-node__postfix' });
    },
    renderExpandIcon: function renderExpandIcon(h) {
      return h('i', { 'class': 'tea-icon tea-icon-arrowright el-icon-arrow-right el-cascader-node__postfix' });
    },
...
// EXTERNAL MODULE: external "honey-ui/lib/utils/aria-utils"
var aria_utils_ = __webpack_require__(42);
