...
module.exports = require("honey-ui/lib/progress");
    ...
    _vm._l(_vm.files, function (file) {
      return _c(
        ...
        [
          ...
          !_vm.disabled
            ? _c("i", {
                staticClass: "el-icon-close tea-icon tea-icon-dismiss size-s",
                on: {
                  click: function ($event) {
...
// EXTERNAL MODULE: external "honey-ui/lib/progress"
