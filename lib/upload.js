...
module.exports = require("@tencent/honey-ui/lib/progress");
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/progress"
...
var upload_draggervue_type_template_id_7ebbf219_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "tea-form-upload-drag",
      class: {
        " tea-form-upload-drag--drag": _vm.dragover
      },
      on: {
        drop: function($event) {
    ...
    [
      !_vm.$slots.default
        ? _c("div", { staticClass: "tea-form-upload__inner" }, [
            _vm._m(0),
            _c(
              "p",
              {
                staticClass:
                  "tea-text tea-text__upload-drag tea-text__upload-drag--hover"
              },
              [_vm._v("释放鼠标")]
            )
          ])
...
var upload_draggervue_type_template_id_7ebbf219_staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "tea-text tea-text__upload-drag" }, [
      _c(
        "a",
        {
          staticClass: "tea-btn tea-btn--link tea-btn--file",
          attrs: { href: "#" }
        },
        [_c("span", [_vm._v("点击上传")])]
      ),
      _c("span", { staticClass: "tea-text-weak" }, [_vm._v("/ 拖拽到此区域")])
    ])
  }
]
