...
module.exports = require("@tencent/honey-ui/lib/mixins/migrating");
...
module.exports = require("@tencent/honey-ui/lib/utils/popup");

/***/ }),
/* 17 */
/***/ (function(module, exports) {

module.exports = require("@tencent/honey-ui/lib/checkbox");
...
module.exports = require("@tencent/honey-ui/lib/tooltip");
...
module.exports = require("@tencent/honey-ui/lib/utils/scrollbar-width");

/***/ }),
/* 40 */
/***/ (function(module, exports) {

module.exports = require("@tencent/honey-ui/lib/checkbox-group");
...
module.exports = require("@tencent/honey-ui/lib/directives/mousewheel");
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "tea-table",
      class: [
        {
          "el-table--fit": _vm.fit,
          "el-table--striped": _vm.stripe,
          "tea-table--bordered": _vm.border || _vm.isGroup,
          "tea-table--inner-bordered": _vm.innerBorder,
    ...
    [
      ...
      _c(
        ...
        {
          ref: "bodyWrapper",
          staticClass: "el-table__body-wrapper-x tea-table__body",
          class: [
            _vm.layout.scrollX
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/checkbox"
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/directives/mousewheel"
var mousewheel_ = __webpack_require__(48);
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/mixins/migrating"
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/utils/scrollbar-width"
...
var table_layout_TableLayout = function () {
  ...
  TableLayout.prototype.updateScrollY = function updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      var body = bodyWrapper.querySelector('.tea-table__box'); // bad
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/tooltip"
    ...
    _vm.multiple
      ? _c(
          ...
          [
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "tea-list tea-list--option tea-list--checkoption"
                      },
                      [
                        _c(
                          "el-checkbox",
                          {
                            attrs: {
                              indeterminate:
                                _vm.filteredValue.length > 0 &&
                                _vm.filteredValue.length < _vm.filters.length
                            },
            ...
            _c("div", { staticClass: "tea-dropdown-box__footer" }, [
              _c(
                "button",
                {
                  staticClass: "tea-btn",
              ...
              _c(
                "button",
                {
                  staticClass: "tea-btn tea-btn--weak",
      ...
      : _c(
          ...
          [
            _c(
              "ul",
              { staticClass: "tea-list tea-list--option" },
              [
                _c(
                  "li",
                  {
                    staticClass: "el-table-filter__list-item-x",
                    class: {
                      "is-selected":
                ...
                _vm._l(_vm.filters, function(filter) {
                  return _c(
                    "li",
                    {
                      key: filter.value,
                      staticClass: "el-table-filter__list-item-x",
                      class: { "is-selected": _vm.isActive(filter) },
                      attrs: { label: filter.value },
                      on: {
                        click: function($event) {
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/utils/popup"
...
// EXTERNAL MODULE: external "@tencent/honey-ui/lib/checkbox-group"
...
/* harmony default export */ var filter_panelvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleCheckAll: function handleCheckAll(val) {
      this.filteredValue = val ? this.filters.map(function (filter) {
        return filter.value;
      }) : [];
  ...
  mounted: function mounted() {
    ...
    this.$watch('showPopper', function (value) {
      if (_this3.column) _this3.column.filterOpened = value;
      if (value) {
        dropdown.open(_this3);
      } else {
        dropdown.close(_this3);
      }
    });
    this.optionChange();
  },
              ...
              return h(
                ...
                [h(
                  ...
                  [column.renderHeader ? column.renderHeader.call(_this._renderProxy, h, { column: column, $index: cellIndex, store: _this.store, _self: _this.$parent.$vnode.context }) : column.label, column.sortable ? h(
                    ...
                    [column.order === 'ascending' ? h('i', { 'class': 'tea-icon tea-icon-sortup' }) : column.order === 'descending' ? h('i', { 'class': 'tea-icon tea-icon-sortdown' }) : h('i', { 'class': 'tea-icon tea-icon-sort' })]
                  ) : '', column.filterable ? h(
                    'span',
                    {
