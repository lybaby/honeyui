...
module.exports = require("honey-ui/lib/checkbox");
...
module.exports = require("honey-ui/lib/transitions/collapse-transition");
...
var external_vue_virtual_scroll_list_ = __webpack_require__(52);
...
var tree_nodevue_type_template_id_3ba3ef0e_render = function () {
  ...
  return _c(
    "div",
    {
      ...
      ref: "node",
      staticClass: "tea-tree__node",
      class: {
        "is-expanded": _vm.expanded,
        "is-selected": _vm.node.isCurrent,
    ...
    [
      _c(
        "div",
        {
          staticClass: "tea-tree__node-content",
          style: {
        ...
        [
          _c(
            "span",
            {
              staticClass: "tea-tree__switcher",
              class: [
                {
          ...
          _vm.node.loading
            ? _c("span", {
                staticClass: "tea-icon tea-icon-loading",
...
// EXTERNAL MODULE: external "honey-ui/lib/transitions/collapse-transition"
var collapse_transition_ = __webpack_require__(23);
var collapse_transition_default = /*#__PURE__*/__webpack_require__.n(collapse_transition_);

// EXTERNAL MODULE: external "honey-ui/lib/checkbox"
...
var tree_virtual_nodevue_type_template_id_7a0bd9fb_render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.source.visible
    ? _c(
        "div",
        {
          ref: "node",
          staticClass: "tea-tree-node",
          class: {
            "is-expanded": _vm.expanded,
            "is-selected": _vm.source.isCurrent,
        ...
        [
          _c(
            "div",
            {
              staticClass: "tea-tree__node-content",
              style: {
                "padding-left": (_vm.source.level - 1) * _vm.tree.indent + "px",
              },
            },
            [
              _c(
                ...
                [
                  !_vm.source.isLeaf
                    ? _c("i", {
                        staticClass: "tea-icon",
                        class:
                          !_vm.source.isLeaf && _vm.expanded
                            ? "tea-icon-arrowdown"
                            : "tea-icon-arrowright",
                      })
                    : _vm._e(),
  ...
  components: {
    ...
    NodeContent: {
      ...
      render: function render(h) {
        ...
        return parent.renderContent ? parent.renderContent.call(parent._renderProxy, h, { _self: tree.$vnode.context, node: node, data: data, store: store }) : tree.$scopedSlots.default ? tree.$scopedSlots.default({ node: node, data: data }) : h('span', {
          style: {
        ...
        }, [data[props.treeLabel || props.label]])], node[props.treeLabel || props.label]);
      }
    }
  },
...
/* harmony default export */ var treevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    isEmpty: function isEmpty() {
      ...
      return this.virtual ? this.visibleList.length === 0 : !childNodes || childNodes.length === 0 || childNodes.every(function (_ref) {
        var visible = _ref.visible;
        return !visible;
      });
    },
    visibleList: function visibleList() {
      return this.virtual ? this.flattenTree(this.root.childNodes) : [];
    }
  },
  ...
  watch: {
    ...
    data: function data(newVal) {
      ...
      if (this.virtual) {
        var keys = this.getInitCheckedKeys(newVal);
  ...
  methods: {
    ...
    getInitCheckedKeys: function getInitCheckedKeys(datas) {
      var _this2 = this;

      var keys = datas.reduce(function (conn, data) {
        if (data.checked !== null && data.checked === true) {
          conn.push(data[_this2.nodeKey]);
        }
        if (data.children && data.children.length > 0) {
          var subKeys = _this2.getInitCheckedKeys(data.children);
  ...
  created: function created() {
    ...
    this.$on('tree-node-drag-start', function (event, treeNode) {
      if (typeof _this3.allowDrag === 'function' && !_this3.allowDrag(treeNode.node)) {
        event.preventDefault();
        return false;
      }
      ...
      _this3.$emit('node-drag-start', treeNode.node, event);
    });
    ...
    this.$on('tree-node-drag-over', function (event, treeNode) {
      ...
      if (typeof _this3.allowDrop === 'function') {
        dropPrev = _this3.allowDrop(draggingNode.node, dropNode.node, 'prev');
        userAllowDropInner = dropInner = _this3.allowDrop(draggingNode.node, dropNode.node, 'inner');
        dropNext = _this3.allowDrop(draggingNode.node, dropNode.node, 'next');
      }
      event.dataTransfer.dropEffect = dropInner ? 'move' : 'none';
      if ((dropPrev || dropInner || dropNext) && oldDropNode !== dropNode) {
        if (oldDropNode) {
          _this3.$emit('node-drag-leave', draggingNode.node, oldDropNode.node, event);
        }
        _this3.$emit('node-drag-enter', draggingNode.node, dropNode.node, event);
      }
      ...
      var treePosition = _this3.$el.getBoundingClientRect();
      ...
      var iconPosition = dropNode.$el.querySelector('.tea-tree__switcher').getBoundingClientRect();
      var dropIndicator = _this3.$refs.dropIndicator;
      if (dropType === 'before') {
      ...
      _this3.$emit('node-drag-over', draggingNode.node, dropNode.node, event);
    });
    ...
    this.$on('tree-node-drag-end', function (event) {
      ...
      if (draggingNode && dropNode) {
        ...
        if (dropType !== 'none') {
          _this3.store.registerNode(draggingNodeCopy);
        }

        Object(dom_["removeClass"])(dropNode.$el, 'is-drop-inner');

        _this3.$emit('node-drag-end', draggingNode.node, dropNode.node, dropType, event);
        if (dropType !== 'none') {
          _this3.$emit('node-drop', draggingNode.node, dropNode.node, dropType, event);
        }
      }
      if (draggingNode && !dropNode) {
        _this3.$emit('node-drag-end', draggingNode.node, null, dropType, event);
      }
