...
/* harmony default export */ var rankvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    scrollToItem: function scrollToItem() {
      var item = this.selectedItem[this.selectedTabIndex];
      var target = this.$refs['item-' + item[this.idName]] && this.$refs['item-' + item[this.idName]][0];
