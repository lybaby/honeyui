...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "tea-step__item",
      class: [
        !_vm.isSimple && "is-" + _vm.$parent.direction,
        _vm.isSimple && "is-simple",
        _vm.isLast && !_vm.space && !_vm.isCenter && "is-flex",
        _vm.isCenter && !_vm.isVertical && !_vm.isSimple && "is-center",
        _vm.currentActive ? "is-current" : ""
      ],
      style: _vm.style
    },
    [
      _c("div", {
        staticClass: "tea-step__num",
        class: "is-" + _vm.currentStatus
      }),
      _c("div", { staticClass: "tea-step__content" }, [
        _c(
          "div",
          {
            ref: "title",
            staticClass: "tea-step__title",
            class: ["is-" + _vm.currentStatus]
          },
        ...
        _vm.isDotStyle
          ? _c("div", { staticClass: "tea-step__description" }, [
              _c("div", { domProps: { innerHTML: _vm._s(_vm.description) } })
            ])
          : _vm._e()
      ]),
      _vm.isAlternativeStyle
        ? _c(
            "div",
            { staticClass: "tea-step__tips" },
            [_vm._t("tips", [_vm._v(_vm._s(_vm.tips))])],
            2
          )
        : _vm._e(),
      !_vm.isLast ? _c("div", { staticClass: "tea-step__arrow" }) : _vm._e()
    ]
  )
}
var staticRenderFns = []
...
/* harmony default export */ var stepvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    isDotStyle: function isDotStyle() {
      return this.$parent.lineStyle === 'dot';
    },
    isAlternativeStyle: function isAlternativeStyle() {
