...
var render = function() {
  ...
  return _c("div", { staticClass: "tea-card" }, [
    _vm.$slots.header || _vm.header
      ? _c(
          "div",
          { staticClass: "tea-card__header" },
    ...
    _c(
      "div",
      { staticClass: "tea-card__body", style: _vm.bodyStyle },
      [_vm._t("default")],
      2
    ),
    _vm.$slots.footer || _vm.footer
      ? _c("div", { staticClass: "tea-card__footer" }, [_vm._t("footer")], 2)
      : _vm._e()
  ])
}
var staticRenderFns = []
