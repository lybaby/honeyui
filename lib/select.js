                  ...
                  _vm._t("display-text", [
                    _vm.displayText !== undefined
                      ? [
                          _vm._v(
                            "\n            " +
                              _vm._s(_vm.displayText || _vm.placeholder) +
                              "\n          "
                          )
                        ]
              ...
              _vm.filterable
                ? _c(
                    "form",
                    {
                      ...
                      on: {
                        mouseenter: function($event) {
                          _vm.filterInputHovering = true
                        },
                        mouseleave: function($event) {
                          _vm.filterInputHovering = false
                        }
                      }
                    },
                    [
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    showFilterClearable: function showFilterClearable() {
      var hasValue = this.multiple ? Array.isArray(this.selected) && this.selected.length > 0 : this.selected.value !== undefined && this.selected.value !== null && this.selected.value !== '';
      var criteria = !this.multiple && this.filterClearable && !this.selectDisabled && this.filterInputHovering && hasValue;
      return criteria;
    },
