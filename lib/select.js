...
module.exports = require("honey-ui/lib/utils/resize-event");
...
module.exports = require("honey-ui/lib/utils/shared");
...
module.exports = require("honey-ui/lib/tag");
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _vm._t("display-text", [
                    _vm.displayText !== undefined
                      ? [
                          _vm._v(
                            "\n            " +
                              _vm._s(
                                _vm.displayText ||
                                  _vm.currentPlaceholder ||
                                  _vm.placeholder
                              ) +
                              "\n          "
                          ),
                        ...
                        [
                          _c("div", { staticClass: "tea-search__inner" }, [
                            _c("input", {
                              ...
                              class: {
                                "tea-input--search-clearable":
                                  _vm.showFilterClearable,
                              },
                          ...
                          _vm.showFilterClearable
                            ? _c(
                                ...
                                {
                                  staticClass:
                                    "tea-btn tea-btn--icon tea-btn--search-clear",
                                  attrs: { type: "button" },
                                  on: { click: _vm.handleFilterClearClick },
                                },
                                [
                                  _c("i", {
                                    staticClass:
                                      "tea-icon tea-icon-dismiss size-s",
                                  }),
                                ]
                              )
                            : _vm._e(),
...
// EXTERNAL MODULE: external "honey-ui/lib/tag"
var tag_ = __webpack_require__(32);
...
// EXTERNAL MODULE: external "honey-ui/lib/utils/resize-event"
...
// EXTERNAL MODULE: external "honey-ui/lib/utils/shared"
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    showCloseNew: function showCloseNew() {
      var hasValue = this.multiple ? Array.isArray(this.selected) && this.selected.length > 0 : this.selected.value !== undefined && this.selected.value !== null && this.selected.value !== '';
      var criteria = this.clearable && !this.selectDisabled && this.inputHovering && hasValue;
      return criteria;
    },
    showFilterClearable: function showFilterClearable() {
      var criteria = !this.multiple && this.filterClearable && !this.selectDisabled && this.query;
      return criteria;
    },
    ...
    selectMenuStyle: function selectMenuStyle() {
    ...
    visible: function visible(val) {
      ...
      if (!val) {
        ...
        if (this.filterable) {
          ...
          this.handleQueryChange(this.query);
          this.$nextTick(function () {
            if (_this3.$refs.queryInput && _this3.$refs.queryInput.focus) {
              _this3.$refs.queryInput.focus();
            }
          });
          if (this.multiple) {
            ...
            // 滚动到选中项
            this.$refs.scrollbar.$children.forEach(function (child) {
              if (child.itemSelected) {
                _this3.$nextTick(function () {
                  var _child$$el$offsetTop = child.$el.offsetTop,
                      offsetTop = _child$$el$offsetTop === undefined ? 0 : _child$$el$offsetTop;
  ...
  methods: {
    ...
    handleFilterClearClick: function handleFilterClearClick(event) {
      this.query = '';
    ...
    deleteCustomSelected: function deleteCustomSelected(event) {
      event.stopPropagation();
      var value = this.multiple ? [] : '';
      this.query = '';
      this.selected = value;
