  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        ...
        _c("span", { ref: "core", staticClass: "tea-switch__toggle" })
      ]
    ),
    _vm.activeIconClass || _vm.activeText
      ? _c(
          "span",
          {
            ...
            class: [
              "el-switch__label-x",
              "el-switch__label--right-x",
              _vm.checked ? "is-active" : ""
            ],
            staticStyle: { "vertical-align": "middle", margin: "0px 5px" }
          },
          [
            _vm.activeIconClass
