    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="活动性质" align>
        <el-checkbox-group v-model="form.type">
          ...
          <el-checkbox label="线下主题活动" name="type" block></el-checkbox>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit" style="margin-right: 10px">立即创建</el-button>
        <el-button type="weak">取消</el-button>
      </el-form-item>
    </el-form>
  </el-card>
</div>
